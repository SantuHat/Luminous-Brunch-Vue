const t={template:`<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
  ...
  </nav>`,methods:{logout(){const l="https://vue3-course-api.hexschool.io/v2/logout";axios.post(l).then(a=>{console.log(a),a.data.message&&(window.location="login.html")})}}};export{t as n};
